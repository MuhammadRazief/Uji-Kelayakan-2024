    ...
    | and give it the Closure to cal    l when that URI is requested.
    |
    */
    ...
    $router->group(['middleware' => 'cors'], function ($router) {
        $router->group(['prefix' => 'lending'], function() use ($router) {
            ...
            $router->delete('/delete/all', 'LendingController@deleteAll');
            ...
            $router->delete('/permanent', 'LendingController@permanentDeleteAll');
                  ...
                  $router->put('/restore/{id}', 'RestorationController@restore');
            });
            ...
            $router->group(['prefix' => 'stuff'], function() use ($router) {
                ...
                $router->delete('/delete/all', 'StuffController@deleteAll');
