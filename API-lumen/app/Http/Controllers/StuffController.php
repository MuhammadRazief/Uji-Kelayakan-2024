    ...
    public function __construct()
{
    ...
    {
        $stuff = Stuff::with('stuffstock', 'lendings')->get();
    ...
    public function store(Request $request)
    {
        ...
        public function show($id)// untuk mencari data yang memiliki id mana yang akan di show 
        {
            try {
                ...
                if (is_null($data)) {
                    return ApiFormatter::sendResponse(400, false, 'bad request', 'Data not found');
                } else {
                    return ApiFormatter::sendResponse(200,true, 'succes', $data);
                }
    ...
    public function deleteAll()
{
    try {
        $stuff = Stuff::all();
        if ($stuff->isEmpty()) {
            return ApiFormatter::sendResponse(404, false, 'No Stuff Data Found');
        }
        ...
        return ApiFormatter::sendResponse(200, true, 'Successfully Moved All Stuff Data to Trash');
    } catch (\Exception $e) {
    ...
    {
        try {
            $stuff = Stuff::onlyTrashed()->where('id', $id)->first();

            
            $stuff->restore();

            return ApiFormatter::sendResponse(200, true, "Berhasil mengembalikan data yang telah di hapus!", $stuff);
