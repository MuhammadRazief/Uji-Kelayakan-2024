    ...
    public function show($id)
{
    ...
    public function deleteAll()
    {
        try {
            ...
            if ($lendings->isEmpty()) {
                return ApiFormatter::sendResponse(404, false, 'No Lending Data Found');
            }
    
            $lendings->each(function ($lending) {
                $lending->delete();
            });
    
            return ApiFormatter::sendResponse(200, true, 'Successfully Moved All Lending Data to Trash');
        } catch (\Exception $e) {
            return ApiFormatter::sendResponse(400, false, $e->getMessage());
        }
    }
